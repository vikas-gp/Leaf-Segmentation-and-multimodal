...
CKPT_PATHS = [
    "fold-weights/ckpt_unet_fold1_bs16_s42.pth",
    "fold-weights/ckpt_unet_fold2_bs16_s42.pth",
    "fold-weights/ckpt_unet_fold3_bs16_s42.pth",
    "fold-weights/ckpt_unet_fold4_bs16_s42.pth",
    "fold-weights/ckpt_unet_fold5_bs16_s42.pth",
    "fold-weights/ckpt_unet_fold1_bs16_s7.pth",
    "fold-weights/ckpt_unet_fold2_bs16_s7.pth",
    "fold-weights/ckpt_unet_fold3_bs16_s7.pth",
    "fold-weights/ckpt_unet_fold4_bs16_s7.pth",
    "fold-weights/ckpt_unet_fold5_bs16_s7.pth"
]

INFER_SIZE = (512, 512)
BASE_THRESH = 0.08
MIN_AREA = 80
OUTPUT_DIR = "output-fold"
CONNECT_MAX_DIST = 40
